...
class OpenAIEmbedder(Embedder):
    ...
    def __init__(self, config: EmbeddingConfig):
        ...
        try:
            ...
            raise EmbedderError("openai package not installed. pip install openai")
...
def build_embedder(config: EmbeddingConfig, cache: Optional[EmbeddingCache] = None) -> CachedEmbedder:
